...
export class GameState extends Schema {
	...
	@type("string") phase: TurnPhase = "MULLIGAN";
	@type("boolean") p1MulliganDone: boolean = false;
	@type("boolean") p2MulliganDone: boolean = false;
	@type("number") mulliganDeadlineAt: number = 0;
